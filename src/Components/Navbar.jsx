    ...
    return (
        <div className="w-full flex h-[10vh] shadow-lg items-center px-4 bg-white fixed">
            ...
            <div className="hidden md:flex gap-4 justify-center items-center">
                {
                    user ? (
                        <button onClick={handleLogOut} className="border border-green-400 text-xl px-4 py-2 rounded-xl hover:bg-green-300 hover:text-white transition duration-300 ease-in-out">
                    LogOut
                </button>        
                    ):(
